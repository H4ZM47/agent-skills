#!/usr/bin/env node
/**
 * Validates .cursor-plugin/marketplace.json and each plugin's .cursor-plugin/plugin.json
 * against JSON schemas from https://github.com/cursor/plugins (vendored under ./schemas).
 */
